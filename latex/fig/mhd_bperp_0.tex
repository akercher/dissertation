...
\begin{tikzpicture}[scale = {0.0125\linewidth},
  ...
  %---------------------------------------------
  \node[base node,draw,shape=circle,fill=gray!30] (R8) at (114.592:1.0) {\tiny $\mbf{U}_{r}$};
  %% \node[base node,draw,shape=circle,fill=gray!30] (R7) at (114.592:1.15621) {\tiny $\mbf{U}^*_{r}$};
  ...
  %% \node[base node,draw,shape=circle,fill=gray!30] (R2) at (42.972:0.66359) {\tiny $\mbf{U}^*_{l}$};
  \node[base node,draw,shape=circle,fill=gray!30] (R1) at (42.972:1.0) {\tiny $\mbf{U}_{l}$};

  %---------------------------------------------
  % connect nodes
  %---------------------------------------------
  \draw[gray,thick](0:0) -- (R1);
