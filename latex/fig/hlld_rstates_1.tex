...
\node[draw=white,text=black!50!] (ur) at (0.43467,0.11647) {$\mbf{U}_{r}$};
\node[draw=white,text=black!50!] (usl) at (0.31820,0.31820) {$\mbf{U}^*_{r}$};
\node[draw=white,text=black!50!] (usr) at (0.11647,0.43467) {$\mbf{U}^*_{2r}$};
\node[draw=white] (usr) at (-0.11647,0.43467) {$\mbf{U}^*_{2l}$};
\node[draw=white] (usl) at (-0.31820,0.31820) {$\mbf{U}^*_{l}$};
\node[draw=white,text=black!50!] (ul) at (-0.43467,0.11647) {$\mbf{U}_{l}$};
