...
To ensure memory is coalesced, the variables need to load to a SoA, as shown below.
\begin{lstlisting}
\struc conservative_variables{
  float *density;
  float *momentum_x;
