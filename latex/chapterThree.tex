...
\end{tabular}
\caption{(Top row) HLLE, (middle row) HLLC, and (bottom row) Roe approximate solution to Sod shock tube problem computed using third-order parabolic interpolation.  Athena \citep{url:athena} was used to compute the approximate solutions.  The exact solution was computed with code written for this dissertation available at: \protect\gitrepo.}
...
\end{tabular}
\caption{Solution of MHD shock tube test 1 at time 0.2.  The initial conditions are given by \eqref{eqn:rj2a_init}.  HLLC-TVD solution generated with Athena \citep{url:athena}.  All other solutions generated with code written for this dissertation: \protect\gitrepo.}
\label{fig:rj2a_plot}
\end{figure}
...
\end{tabular}
\caption{Solution of MHD shock tube test 2 at time 0.2.  The initial conditions are given by \eqref{eqn:AK2_init}.  HLLC-TVD solution generated with Athena \citep{url:athena}.  All other solutions generated with code written for this dissertation: \protect\gitrepo.}
\label{fig:AK2_plot}
\end{figure}
...
\end{tabular}
\caption{Solution of MHD shock tube test 3 at time 0.3.  The initial conditions are given by \eqref{eqn:AK3_init}. HLLC-TVD solution generated with Athena \citep{url:athena}.  All other solutions generated with code written for this dissertation: \protect\gitrepo.}
\label{fig:AK3_plot}
\end{figure}
...
\end{tabular}
\caption{Solution of MHD shock tube test 4 at time 0.2.  The initial conditions are given by \eqref{eqn:AK4_init}. HLLC-TVD solution generated with Athena \citep{url:athena}.  All other solutions generated with code written for this dissertation: \protect\gitrepo.}
\label{fig:AK4_plot}
\end{figure}
...
\end{tabular}
\caption{Solution of MHD shock tube test 5a \eqref{eqn:AK5_init} with $\alpha = \pi$, at time 0.2066. HLLC-TVD solution generated with Athena \citep{url:athena}.  All other solutions generated with code written for this dissertation: \protect\gitrepo.}
\label{fig:AK5_plot}
\end{figure}
...
\end{tabular}
\caption{Solution of MHD shock tube test 5b \eqref{eqn:AK5_init} with $\alpha = 3.0$, at time 0.2066. HLLC-TVD solution generated with Athena \citep{url:athena}.  All other solutions generated with code written for this dissertation: \protect\gitrepo.}
\label{fig:AK5b_plot}
\end{figure}
...
\end{tabular}
\caption{Solution of MHD shock tube test 6a \eqref{eqn:AK6_init} with $\alpha = \pi$, at time 0.15. HLLC-TVD solution generated with Athena \citep{url:athena}.  All other solutions generated with code written for this dissertation: \protect\gitrepo.}
\label{fig:AK6_plot}
\end{figure}
...
\end{tabular}
\caption{Solution of MHD shock tube test 6b \eqref{eqn:AK6_init} with $\alpha=3.0$, at time 0.15. HLLC-TVD solution generated with Athena \citep{url:athena}.  All other solutions generated with code written for this dissertation: \protect\gitrepo.}
\label{fig:AK6b_plot}
\end{figure}
...
\end{tabular}
\caption{Solution of MHD shock tube test 7 \eqref{eqn:AK7_init} at time 0.05. HLLC-TVD solution generated with Athena \citep{url:athena}.  All other solutions generated with code written for this dissertation: \protect\gitrepo.}
\label{fig:AK7_plot}
\end{figure}
...
\end{tabular}
\caption{Top: initial state of left-going rotational discontinuity for the coplanar case of Test~5.  Middle: the left-going rotational discontinuity for the coplanar case of Test~5 after onetime step.  The gas pressure is increased as a result of the decrease in $B_t$.  Bottom: the left-going rotational discontinuity for the coplanar case of Test~5 after two time steps.  The artificial increase in pressure creates the compound wave.}
