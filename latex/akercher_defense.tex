...
%----------------------------------------------------------------------------------------
\begin{frame}[fragile]
\frametitle{Higher order Schemes}
%% \begin{columns}
%% \begin{column}{0.5\textwidth}
%% \only<1-1>{
%% \begin{figure}[htbp]
...
\includemovie[
  ...
  controls=false,
  %% width=0.75\textwidth
%% text={\includegraphics[width=0.5\textwidth]{tikz/face_color_1.pdf}}]{0.5\textwidth}{}{kh_instability_10_fps.avi}
text={\includegraphics[width=0.5\textwidth]{kh0.jpg}}]{0.5\textwidth}{}{kh_instability_10_fps.avi}
